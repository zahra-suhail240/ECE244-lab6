...
Shape* parseRectangleCommand(stringstream& line){
    ...
    // Create the shape object and return a pointer to it
    Shape* rectShape = (Shape*) new Rectangle(name, xcent, ycent, width, height);
...
Shape* parseTriangleCommand(stringstream& line){
    ...
    line >> name >> x1coord >> y1coord >> x2coord >> y2coord >> x3coord >> y3coord;
    ...
    // Create the shape object and return a pointer to it
    Shape* triShape = (Shape*) new Triangle(name, xcent, ycent, x1coord, y1coord, x2coord, y2coord, x3coord, y3coord);
